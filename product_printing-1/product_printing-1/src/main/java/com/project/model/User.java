...
public class User {
	...
	@Embedded
	@ElementCollection
	@CollectionTable(name = "payment_nformation", joinColumns = @JoinColumn(name = "user_id"))
	...
	public User(Long id, String firstName, String lastName, String password, String email, String role, String mobile,
			String otp, LocalDateTime otpGeneratedTime, boolean active, List<Address> address,
			List<PaymentInformation> paymentInformations, List<Rating> ratings, List<Review> reviews,
