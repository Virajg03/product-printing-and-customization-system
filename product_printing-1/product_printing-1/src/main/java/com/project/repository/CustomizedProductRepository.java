...
public interface CustomizedProductRepository extends JpaRepository<CustomizedProduct, Long>{
	...
	@Query("SELECT p FROM CustomizedProduct p " +
		...
		public List<CustomizedProduct> filterProduct(@Param("category") String category,
		                                   @Param("minPrice") Integer minPrice,
		                                   @Param("maxPrice") Integer maxPrice,
		                                   @Param("minDiscount") Integer minDiscount,
		                                   @Param("sort") String sort);
	
	public List<CustomizedProduct> findTop10ByOrderByCreatAtDesc();
