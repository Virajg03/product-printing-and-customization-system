...
//         >
//           {/* Your mobile filter dialog content */}
//           <Transition.Child
//               as={Fragment}
...
//             </h1>
//             {/* Sorting options */}
//             {/* Your sorting options code here */}
//           </div>
...
//       {/* Pagination section */}
//       {/* Your pagination section code here */}
...
// import {produts} from "../../../State/Store"
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
              <div>
                <div className="py-10 flex justify-between items-center">
                  <h1 className="text-lg opacity-15 font-bold">FILTERS</h1>
                  <FilterListIcon />
                </div>
