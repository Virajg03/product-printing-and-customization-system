export const ADD_ITEM_TO_CART_REQUEST="ADD_ITEM_TO_CARD_REQUEST";
export const ADD_ITEM_TO_CART_SUCCESS="ADD_ITEM_TO_CARD_SUCCESS";
export const ADD_ITEM_TO_CART_FAILURE="ADD_ITEM_TO_CARD_FAILURE";
